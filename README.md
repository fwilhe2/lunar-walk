...
- **It sparkles** — on the airless bodies. Sparse micro-facets of impact glass catch the sun within a dozen metres of your boots, gated by the lit colour so nothing glints inside a shadow. Mars and Venus have none: that glass is made by micrometeorite melting, and both of them have air. Venus has no opposition surge either — that needs a collimated source, and there is not one within twenty kilometres of the ground.
